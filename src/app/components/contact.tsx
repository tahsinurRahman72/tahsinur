export default function Contact() {
    return (
        <>
            <div id="contact-heading" className="flex justify-start text-5xl min-[2560px]:text-8xl min-[2560px]:m-12 font-sans text-white items-center">
            <h1>
                Contact
            </h1>
            </div>

            <div className="mx-auto mt-10 flex min-[2560px]:m-12 flex-wrap justify-center items-center gap-x-10 gap-y-20 sm:gap-x-14 lg:mx-0 lg:max-w-none lg:flex-nowrap">
            {/* <!-- Github --> */}
